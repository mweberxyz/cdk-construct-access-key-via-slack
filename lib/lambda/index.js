...
const handler = async (event) => {
    ...
    const respondToCloudformation = async (body) => {
        const response = await node_fetch_1.default(event.ResponseURL, {
            method: "put",
            headers: {
                "content-type": "",
            },
    ...
    try {
        ...
        const sendSlackWebhook = async (body) => {
            const response = await node_fetch_1.default(WEBHOOK_URL, {
                method: "post",
                headers: {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(740);
